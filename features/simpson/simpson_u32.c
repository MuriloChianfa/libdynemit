...
static double
simpson_u32_sse2(const uint32_t *data, size_t n)
{
    return simpson_u32_scalar(data, n);
}

__attribute__((target("sse4.2")))
static double
simpson_u32_sse42(const uint32_t *data, size_t n)
{
    return simpson_u32_scalar(data, n);
}
...
static double
simpson_u32_avx2(const uint32_t *data, size_t n)
{
    return simpson_u32_avx(data, n);
}
...
static double
simpson_u32_sve(const uint32_t *data, size_t n)
{
    return simpson_u32_scalar(data, n);
}
...
static double
simpson_u32_sve2(const uint32_t *data, size_t n)
{
    return simpson_u32_scalar(data, n);
}
...
simpson_u32_fn_t
simpson_u32_select(simd_level_t level)
{
    switch (level) {
#if defined(__x86_64__) || defined(__i386__)
    case SIMD_AVX512F: return simpson_u32_avx512f;
    case SIMD_AVX2:    return simpson_u32_avx2;
    case SIMD_AVX:     return simpson_u32_avx;
...
static simpson_u32_fn_t
simpson_u32_resolver(void)
{
    return simpson_u32_select(detect_simd_level());
}
