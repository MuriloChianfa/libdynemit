...
DYNEMIT_IFUNC_SETUP(variance_f64_fn_t, variance_f64, variance_f64_resolver)

#if defined(DYNEMIT_NO_IFUNC)
double variance_f64(const double *data, size_t n)
{
    return DYNEMIT_IFUNC_INVOKE(variance_f64, (data, n));
}
#else
#if defined(__x86_64__) || defined(__i386__)
...
#endif
double variance_f64(const double *data, size_t n)
    DYNEMIT_IFUNC_ATTR("variance_f64_resolver");
#endif
