...
static double
hll_u64_sse42(const uint64_t *data, size_t n)
{
    return hll_u64_sse2(data, n);
}
...
{
    return hll_u64_scalar(data, n);
}

__attribute__((target("+sve")))
static double
hll_u64_sve(const uint64_t *data, size_t n)
{
    return hll_u64_scalar(data, n);
}
...
static double
hll_u64_sve2(const uint64_t *data, size_t n)
{
    return hll_u64_scalar(data, n);
}
...
hll_u64_fn_t
hll_u64_select(simd_level_t level)
{
    switch (level) {
#if defined(__x86_64__) || defined(__i386__)
