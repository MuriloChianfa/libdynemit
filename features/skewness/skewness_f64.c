...
DYNEMIT_IFUNC_SETUP(skewness_f64_fn_t, skewness_f64, skewness_f64_resolver)

#if defined(DYNEMIT_NO_IFUNC)
double skewness_f64(const double *data, size_t n)
{
    return DYNEMIT_IFUNC_INVOKE(skewness_f64, (data, n));
}
#else
#if defined(__x86_64__) || defined(__i386__)
...
#endif
double skewness_f64(const double *data, size_t n)
    DYNEMIT_IFUNC_ATTR("skewness_f64_resolver");
#endif
